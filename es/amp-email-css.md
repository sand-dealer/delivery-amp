...
Además de una hoja de estilo interna, los estilos en línea se pueden especificar en cualquier elemento utilizando el [atributo de `style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style) .
